 ...
 * @source $URL$
 */
public class CUBRIDTestSetup extends JDBCTestSetup {
    ...
    protected JDBCDataStoreFactory createDataStoreFactory() {
        return new CUBRIDDataStoreFactory();
    }
    ...
    protected Properties createExampleFixture() {
        ...
        p.put("driver", "cubrid.jdbc.driver.CUBRIDDriver");
        p.put("url", "jdbc:cubrid://localhost/geotools");
