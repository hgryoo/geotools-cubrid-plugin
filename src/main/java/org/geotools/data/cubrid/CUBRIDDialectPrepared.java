...
/**
 * CUBRID database dialect based on prepared statements.
 * 
 ...
 * @source $URL$
 */
public class CUBRIDDialectPrepared extends PreparedStatementSQLDialect {

    CUBRIDDialect delegate;
    
    public CUBRIDDialectPrepared(JDBCDataStore dataStore) {
        super( dataStore );
