...
/**
 * CUBRID database dialect based on basic (non-prepared) statements.
 * 
 ...
 * @source $URL$
 */
public class CUBRIDDialectBasic extends BasicSQLDialect {
    
    CUBRIDDialect delegate;
    
    public CUBRIDDialectBasic(JDBCDataStore dataStore) {
        super( dataStore );
        delegate = new CUBRIDDialect(dataStore);
    }
